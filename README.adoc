...
as the following example (from `src/main/java/dev/sharanggupta/gs_messaging_redis/Receiver.java`)
shows:

====
[source,java]
----
include::src/main/java/dev/sharanggupta/gs_messaging_redis/Receiver.java[]
----
====
...
`src/main/java/dev/sharanggupta/gs_messaging_redis/MessagingRedisApplication.java`) shows:

====
[source,java]
----
include::src/main/java/dev/sharanggupta/gs_messaging_redis/GsMessagingRedisApplication.java[]
----
====
...
[source,bash]
----
yyyy-mm-ddT07:08:48.646-04:00  INFO 18338 --- [main] d.s.g.GsMessagingRedisApplication: Sending message...
yyyy-mm-ddT07:08:48.663-04:00  INFO 18338 --- [container-1] dev.sharanggupta.gs_messaging_redis.Receiver      : Received <Hello from Redis!>
----
====
